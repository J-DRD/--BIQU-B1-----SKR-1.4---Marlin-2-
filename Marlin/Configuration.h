...
#define STRING_CONFIG_H_AUTHOR "(J-DRD, BIQU_B1SE)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "B1SE-090323"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // BIQU B1
    ...
    #define DEFAULT_Kp_LIST {  29.92,  29.92 }
    #define DEFAULT_Ki_LIST {   3.24,   3.24 }
    #define DEFAULT_Kd_LIST {  69.04,  69.04 }
  #else
    #define DEFAULT_Kp  29.92
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // BIQU B1
  #define DEFAULT_bedKp 124.24
  #define DEFAULT_bedKi 18.76
  #define DEFAULT_bedKd 548.49
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 5, 16 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 150, 150, 10, 24 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 400, 400, 50, 4500 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 600, 600, 100, 9000 } // ...or, set your own edit limits
#endif
 ...
 */
#define DEFAULT_ACCELERATION           270    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION   480    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION    360    // X, Y, Z acceleration for travel (non printing) moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -1.70, -33.0, -3.40 }
...
#ifdef B1_USE_BLTOUCH
  #define AUTO_BED_LEVELING_LINEAR //AUTO_BED_LEVELING_BILINEAR
#else
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_RETRACT_MULTIPLIER   1.05  // G26 Q (retraction) used by default between mesh test elements.
  #endif
...
#define LCD_BED_LEVELING
  ...
  #define LCD_PROBE_Z_RANGE 1.0     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
...
//#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_Z_HOP       4.5        // (mm) Z height of nozzle between leveling points
  #define BED_TRAMMING_INCLUDE_CENTER       // Move to the center after the last corner
  //#define BED_TRAMMING_USE_PROBE
  #if ENABLED(BED_TRAMMING_USE_PROBE)
    #define BED_TRAMMING_PROBE_TOLERANCE 0.09  // (mm)
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { { 11, 55, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { 9, 110, (Z_MIN_POS + 1) } }

  // Circular pattern radius
  #define NOZZLE_CLEAN_CIRCLE_RADIUS 4
  // Circular pattern circle fragments number
  #define NOZZLE_CLEAN_CIRCLE_FN 6
  ...
  #define NOZZLE_CLEAN_MIN_TEMP 212
  #define NOZZLE_CLEAN_HEATUP       // Heat up the nozzle instead of skipping wipe

  // Explicit wipe G-code script applies to a G12 with no arguments.
  #define WIPE_SEQUENCE_COMMANDS "G1 X10 Y80 Z8 F275\nG1 Z4 F225\nM114\n"
...
//#define TOUCH_SCREEN
  ...
  #define TOUCH_IDLE_SLEEP_MINS 6 // (minutes) Display Sleep after a period of inactivity. Set with M255 S.

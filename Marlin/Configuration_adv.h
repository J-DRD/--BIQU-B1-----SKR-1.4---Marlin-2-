...
//
  ...
  #define CHAMBER_CHECK_INTERVAL 10000   // (ms) Interval between checks in bang-bang control
...
#define AUTOTEMP
#if ENABLED(AUTOTEMP)
  #define AUTOTEMP_OLDWEIGHT    0.84  // Factor used to weight previous readings (0.0 < value < 1.0)
  // Turn on AUTOTEMP on M104/M109 by default using proportions set here
  #define AUTOTEMP_PROPORTIONAL
  #if ENABLED(AUTOTEMP_PROPORTIONAL)
    #define AUTOTEMP_MIN_P      -2.0 // (°C) Subtracted from the target temperature
    #define AUTOTEMP_MAX_P      +2.0 // (°C) Added to the target temperature
    #define AUTOTEMP_FACTOR_P   0.96  // Apply this F parameter by default (overridden by M104/M109 F)
  #endif
#endif
...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_NOZZLE_TARGET   80     // (°C) Safe temperature for the nozzle after timeout
 ...
 */
#define FAN_KICKSTART_TIME  120  // (ms)
...
//#define INPUT_SHAPING_Y
  ...
  #define SHAPING_MAX_STEPRATE 15000  // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage.
...
#define MINIMUM_PLANNER_SPEED 0.04 // (mm/s)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 40*60, 40*60, 40*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_10X_STEPS_PER_SEC   24  // (steps/s) Encoder rate for 10x speed
  #define ENCODER_100X_STEPS_PER_SEC  36  // (steps/s) Encoder rate for 100x speed
#endif

// Play a beep when the feedrate is changed from the Status Screen
#define BEEP_ON_FEEDRATE_CHANGE
#if ENABLED(BEEP_ON_FEEDRATE_CHANGE)
  #define FEEDRATE_CHANGE_BEEP_DURATION   15
  #define FEEDRATE_CHANGE_BEEP_FREQUENCY 850
#endif
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 3  // (minutes) Timeout before turning off the backlight
  ...
  //#define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -3.2
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define EVENT_GCODE_SD_ABORT "M84" // G-code to run on Stop Print (e.g., "G28XY" or "G27")
  ...
  //#define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_MIN_Z_CHANGE 0.10 // (mm) Minimum Z change before saving power-loss data
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_CACHE_VFATS 1      // Maximum number of 13-byte VFAT entries to use for sorting.
  ...
  #define SD_ABORT_ON_ENDSTOP_HIT
    ...
    #define SD_ABORT_ON_ENDSTOP_HIT_GCODE "M84" // G-code to run on endstop hit (e.g., "G28XY" or "G27")
  #endif
 ...
 */
#define SAFE_BED_LEVELING_START_X 20.0
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define MIN_ARC_SEGMENT_MM      0.8  // (mm) Minimum length of each arc segment
  #define MAX_ARC_SEGMENT_MM      3.2 // (mm) Maximum length of each arc segment
  #define MIN_CIRCLE_SEGMENTS    32   // Minimum number of segments in a complete circle
  #define ARC_SEGMENTS_PER_SEC 6   // Use the feedrate to choose the segment length
  #define N_ARC_CORRECTION       18   // Number of interpolated segments between corrections
...
#define MIN_STEPS_PER_SEGMENT 1 // 8
...
#define NO_TIMEOUTS 2000 // Milliseconds
...
//#define FWRETRACT
  ...
  #define FWRETRACT_AUTORETRACT             // Override slicer retractions
    ...
    #define MIN_AUTORETRACT             0.05 // (mm) Don't convert E moves under this length
    #define MAX_AUTORETRACT             5.00 // (mm) Don't convert E moves over this length
  #endif
  #define RETRACT_LENGTH               2.5   // (mm) Default retract length (positive value)
  #define RETRACT_LENGTH_SWAP          7.5   // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE              7  // (mm/s) Default feedrate for retracting
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     24  // (mm/s) Unload filament feedrate. This can be pretty fast.
  ...
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        0.5  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT       3.0  // (mm) Unload initial retract length.
  #define FILAMENT_UNLOAD_PURGE_DELAY       7000  // (ms) Delay for the filament to cool after retract.
  #define FILAMENT_UNLOAD_PURGE_LENGTH         0.3  // (mm) An unretract is done, then this length is purged.
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      0.7  // (mm/s) feedrate to purge before unload
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       625        // (mA) RMS current
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       625        // (mA) RMS current
    #define Y_CURRENT_HOME  Y_CURRENT
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       775        // (mA) RMS current
    #define Z_CURRENT_HOME  Z_CURRENT
  ...
  #if AXIS_IS_TMC(Z2)
    #define Z2_CURRENT       700        // (mA) RMS current
    #define Z2_CURRENT_HOME  Z2_CURRENT
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT       550        // (mA) RMS current
    #define E0_CURRENT_HOME  E0_CURRENT
    #define E0_MICROSTEPS     16    // 0..256
    #define E0_RSENSE          0.11
    #define E0_CHAIN_POS      -1
  #endif
  ...
  #if AXIS_IS_TMC(E1)
    #define E1_CURRENT       550        // (mA) RMS current
    #define E1_CURRENT_HOME  E1_CURRENT
    #define E1_MICROSTEPS     16    // 0..256
    #define E1_RSENSE          0.11
    #define E1_CHAIN_POS      -1
  #endif
...
#define E6_HYBRID_THRESHOLD     20
#define E7_HYBRID_THRESHOLD     20
 ...
 */
//#define STARTUP_COMMANDS "M117 PWR-ON\n"
...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "LITE MENU [J-DRD]"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 SCRIPT DONE!\n"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  //#define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Update Mesh UBL"
  #define MAIN_MENU_ITEM_1_GCODE "M117 Not Implemented Yet!"
...
#define CUSTOM_MENU_CONFIG
  ...
  #define CUSTOM_MENU_CONFIG_TITLE "FULL MENU [J-DRD]"
  #define CUSTOM_MENU_CONFIG_SCRIPT_DONE "M117 SCRIPT DONE!"
  #define CUSTOM_MENU_CONFIG_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_CONFIG_SCRIPT_RETURN  // Return to status screen after a script
  #define CUSTOM_MENU_CONFIG_ONLY_IDLE        // Only show custom menu when the machine is idle

  #define CONFIG_MENU_ITEM_1_DESC "TEST-ACTION"
  #define CONFIG_MENU_ITEM_1_GCODE "M117 Test Triggered"
